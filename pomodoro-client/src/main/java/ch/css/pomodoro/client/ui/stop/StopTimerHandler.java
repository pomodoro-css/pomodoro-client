...
public class StopTimerHandler {
	...
	public void stopTimer() {
		...
		if (isSuccessful) {
			UserInfo.getTrayIcon().displayMessage("Stop timer", "Your timer has been stopped", MessageType.INFO);
			...
			UserInfo.getTrayIcon().displayMessage("Stop timer", "Unable to stop yout timer. Please start again.",
					MessageType.WARNING);
		}
	}
